      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
              ...
              navigationItems.filter((item: any) => item.allowUnassigned === true).map((item: NavigationItem) => {
                ...
                return (
                  <Link
                    key={item.name}
                    href={item.href}
                    className="flex items-center space-x-2 px-3 py-2 rounded-md text-sm font-normal text-muted-foreground"
                  >
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              type="button"
              className="md:hidden p-2 rounded-md text-muted-foreground hover:text-muted-foreground hover:bg-muted focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500"
              ...
              navigationItems.filter((item: any) => item.allowUnassigned === true).map((item: NavigationItem) => {
                ...
                return (
                  <Link
                    key={item.name}
                    href={item.href}
                    className="flex items-center space-x-2 px-3 py-2 rounded-md text-base font-medium text-muted-foreground"
