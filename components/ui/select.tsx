...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "bg-card/5 border-white/10 text-foreground data-[placeholder]:text-muted-foreground",
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          "bg-[#161D2B] border border-white/8 text-foreground shadow-xl shadow-black/40",
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-card/5 focus:text-foreground text-muted-foreground",
        "[&_svg:not([class*='text-'])]:text-muted-foreground",
