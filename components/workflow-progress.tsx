...
function StepCard({
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      {conditionLabel && (
        <div className="mb-2 px-3 py-1 rounded-full bg-muted border border-white/10">
      ...
      <div
        ...
        className={cn(
          ...
          isNext ? 'bg-card border-2 border-dashed border-white/15' : `bg-gradient-to-br ${config.gradient} shadow-lg`,
      ...
      >
        ...
        {isCompleted && (
          <div className="absolute -top-1.5 -right-1.5">
            <CheckCircle2 className="w-5 h-5 text-green-500 bg-card rounded-full" />
          </div>
        )}
        {isWaiting && (
          <div className="absolute -top-1.5 -right-1.5">
            <Clock className="w-5 h-5 text-amber-500 bg-card rounded-full" />
          </div>
        )}
        ...
        <div className={cn(
          ...
          isNext ? 'bg-muted' : config.iconBg
        )}>
          <Icon className={cn('w-6 h-6', isNext ? 'text-muted-foreground' : config.iconColor)} />
        </div>

        {/* Label */}
        <p className={cn(
          'font-semibold text-sm text-center leading-tight mb-1',
          isNext ? 'text-foreground' : 'text-white'
        )}>
          {node.label}
        </p>
        ...
        <span className={cn(
          ...
          isNext ? 'bg-muted text-muted-foreground' : 'bg-card/20 text-white/90'
        )}>
          {config.label}
        </span>
        ...
        {assignedUserName && (
          <div className={cn(
            ...
            isNext ? 'text-muted-foreground' : 'text-white/80'
          )}>
    ...
    <Card>
      ...
      <CardContent>
        ...
        <div className="flex items-center justify-center gap-6 mt-4 pt-3 border-t text-xs text-muted-foreground">
          ...
          <div className="flex items-center gap-1.5">
            <div className="w-4 h-3 border-2 border-dashed border-white/15 rounded" />
            <span>Next</span>
          </div>
        </div>
      </CardContent>
