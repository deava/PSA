...
function LoadingOverlay({ isVisible, progress }: LoadingOverlayProps) {
  ...
  return (
    <div
      ...
      className={`fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-[#080B0F] transition-opacity duration-300 ${
    ...
    >
      ...
      <div className="mb-10 relative flex items-center justify-center">
        ...
        <div className="absolute w-64 h-64 rounded-full pointer-events-none" style={{
          background: 'radial-gradient(circle, rgba(0,194,168,0.28) 0%, rgba(0,194,168,0.08) 50%, transparent 70%)',
          filter: 'blur(20px)',
        }} />
        ...
        <img
          ...
          style={{
            filter: 'brightness(1.5) drop-shadow(0 0 12px rgba(0,194,168,0.9)) drop-shadow(0 0 32px rgba(0,194,168,0.6)) drop-shadow(0 0 60px rgba(0,194,168,0.3))',
          }}
        />
      </div>
      ...
      <div className="w-64 space-y-3">
        {/* Progress bar */}
        <div className="h-1.5 w-full overflow-hidden rounded-full bg-card/8">
          <div
            className="h-full rounded-full bg-gradient-to-r from-primary via-primary/80 to-primary/60 transition-all duration-300 ease-out"
