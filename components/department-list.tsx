                    ...
                    {canManageDepartments && (
                      <div className="flex items-center space-x-1">
                        <Link href={`/departments/${department.id}/admin`}>
                          <button 
                            className="inline-flex items-center justify-center h-8 w-8 rounded-md text-muted-foreground transition-colors hover:bg-muted hover:text-foreground focus:outline-none focus:ring-2 focus:ring-gray-300"
                        ...
                        >
                          <button 
                            className="inline-flex items-center justify-center h-8 w-8 rounded-md text-red-600 transition-colors hover:bg-destructive/10 hover:text-red-700 focus:outline-none focus:ring-2 focus:ring-red-300"
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        <p className="text-sm font-medium text-foreground">{metrics.activeProjects}</p>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        <p className="text-sm font-medium text-foreground">{metrics.teamSize}</p>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-medium text-foreground">{metrics.capacityUtilization}%</span>
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex space-x-2">
                      <Badge className="bg-green-100 text-emerald-400 border-green-200 hover:!bg-green-200 hover:!text-emerald-400">
                        {metrics.projectHealth.healthy} Healthy
                      </Badge>
                      {metrics.projectHealth.atRisk > 0 && (
                        <Badge className="bg-yellow-100 text-amber-400 border-yellow-200 hover:!bg-yellow-200 hover:!text-amber-400">
                          {metrics.projectHealth.atRisk} At Risk
                        </Badge>
                      )}
                      {metrics.projectHealth.critical > 0 && (
                        <Badge className="bg-red-100 text-destructive border-red-200 hover:!bg-red-200 hover:!text-destructive">
