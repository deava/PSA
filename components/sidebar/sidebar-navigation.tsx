...
export function SidebarNavigation() {
  ...
  if (!isMounted) {
    return (
      <aside className="w-60 flex-shrink-0 bg-[var(--sidebar-bg)] border-r border-[var(--sidebar-border)] flex flex-col h-screen">
        <div className="h-20 px-4 border-b border-[var(--sidebar-border)] flex items-center">
          <div className="h-14 w-28 bg-[var(--sidebar-active-bg)] rounded animate-pulse" />
        </div>
  ...
  return (
    <aside aria-label="Sidebar" className="w-60 flex-shrink-0 bg-[var(--sidebar-bg)] border-r border-[var(--sidebar-border)] flex flex-col h-screen">
      {/* Logo */}
      <div className="h-20 px-4 border-b border-[var(--sidebar-border)] flex items-center justify-center relative overflow-hidden">
        {/* Teal glow background */}
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="w-24 h-24 rounded-full" style={{
            background: 'radial-gradient(circle, rgba(0,194,168,0.35) 0%, rgba(0,194,168,0.12) 50%, transparent 70%)',
            filter: 'blur(10px)',
          }} />
        </div>
        <Link
          ...
          style={{ filter: 'brightness(1.4) drop-shadow(0 0 8px rgba(0,194,168,0.9)) drop-shadow(0 0 20px rgba(0,194,168,0.6)) drop-shadow(0 0 40px rgba(0,194,168,0.3))' }}
        >
