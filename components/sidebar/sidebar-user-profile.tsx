        ...
        <DropdownMenuTrigger asChild>
          <button
            className={cn(
              ...
              'hover:bg-[var(--sidebar-hover-bg)] transition-colors duration-150',
          ...
          >
            ...
            <ChevronUp className="h-3.5 w-3.5 text-[var(--sidebar-text-muted)] flex-shrink-0" />
          </button>
        </DropdownMenuTrigger>
        <DropdownMenuContent
          align="end"
          side="top"
          className="w-56 mb-1 bg-[var(--popover)] border-[var(--border)]"
          sideOffset={4}
        >
          <div className="px-2 py-1.5 border-b border-[var(--border)]">
            <p className="text-[13px] font-semibold truncate text-foreground">{userProfile.name}</p>
