  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        {/* Stats grid */}
        <div className="grid grid-cols-2 gap-2">
          <div className="bg-primary/10 dark:bg-blue-950/30 rounded-lg p-2.5">
          ...
          <div className="bg-amber-500/10 dark:bg-amber-950/30 rounded-lg p-2.5">
            <div className="flex items-center gap-1.5">
          ...
          <div className={`rounded-lg p-2.5 ${data.overdue > 0 ? 'bg-destructive/10 dark:bg-red-950/30' : 'bg-muted/50'}`}>
            <div className="flex items-center gap-1.5">
          ...
          <div className="bg-emerald-500/10 dark:bg-green-950/30 rounded-lg p-2.5">
            <div className="flex items-center gap-1.5">
