...
export function NodeSidebar() {
  ...
  return (
    <div className="w-64 bg-card border-r border-white/10 p-4 overflow-y-auto h-full">
      <h3 className="font-semibold text-sm text-foreground mb-3">Workflow Nodes</h3>
      ...
      <div className="mt-6 space-y-3">
        <div className="p-3 bg-primary/10 border border-blue-200 rounded-lg">
          <p className="text-xs font-semibold text-primary mb-2">Getting Started</p>
        ...
        <div className="p-3 bg-emerald-500/10 border border-green-200 rounded-lg">
          <p className="text-xs font-semibold text-emerald-400 mb-2">Workflow Rules</p>
        ...
        <div className="p-3 bg-purple-500/10 border border-purple-200 rounded-lg">
          <p className="text-xs font-semibold text-purple-400 mb-2">Example: Video Project</p>
