    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          {/* Node Types Section */}
          <div>
            <h3 className="font-semibold text-sm text-foreground mb-3">Available Workflow Nodes</h3>
              ...
              {nodeTypes.map((nodeType) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-xs text-foreground">{nodeType.description}</p>
                  </div>
                );
              })}
            </div>
          ...
          <div className="p-4 bg-primary/10 border border-blue-200 rounded-lg">
            ...
            <ol className="text-sm text-primary space-y-2">
          ...
          {/* Best Practices */}
          <div className="p-4 bg-emerald-500/10 border border-green-200 rounded-lg">
            <h3 className="font-semibold text-sm text-emerald-400 mb-3">Best Practices</h3>
          ...
          <div className="p-4 bg-purple-500/10 border border-purple-200 rounded-lg">
            <h3 className="font-semibold text-sm text-purple-400 mb-3">Example: Video Production Workflow</h3>
          ...
          <div className="p-4 bg-card border border-white/10 rounded-lg">
            <h3 className="font-semibold text-sm text-foreground mb-3">Keyboard Shortcuts & Tips</h3>
