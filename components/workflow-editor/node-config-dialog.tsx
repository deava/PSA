    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4 py-4">
                    ...
                    <>
                      ...
                      {selectedFormField && selectedField && (
                        <div className="space-y-4">
                          {/* Add Branch Builder */}
                          <div className="p-3 border border-dashed border-white/15 rounded-lg bg-card/50 space-y-3">
                            <Label className="text-xs font-medium text-foreground">Add New Branch</Label>
                          ...
                          <div className="space-y-2">
                            ...
                            {conditionBranches.length === 0 ? (
                              <div className="p-3 bg-card border border-white/10 rounded-lg text-center">
                              ...
                              <div className="space-y-2">
                                {conditionBranches.map((branch:any) => (
                                  <div key={branch.id} className="flex items-center gap-2 p-2 bg-card rounded border">
                                    <div
          ...
          {nodeData.type === 'sync' && (
            <div className="p-4 bg-indigo-500/10 border border-indigo-200 rounded-lg">
              <div className="flex items-start gap-3">
                <Info className="w-5 h-5 text-indigo-600 flex-shrink-0 mt-0.5" />
                <div>
                  <p className="text-sm font-medium text-indigo-400">Synchronization Point</p>
