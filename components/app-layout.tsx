    ...
    return (
      <div className="flex h-screen bg-[var(--background)]">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          <header className="h-14 border-b bg-[var(--background)] border-[var(--border)] flex items-center justify-between px-4">
            <div className="h-6 w-40 bg-card/5 rounded animate-pulse" />
            <div className="w-8 h-8 bg-card/5 rounded-full animate-pulse" />
          </header>
          <main role="main" className="flex-1 overflow-auto p-6 bg-[var(--background)]">
            <div className="max-w-[1400px] mx-auto space-y-4">
              <div className="h-8 w-64 bg-card/5 rounded animate-pulse" />
              <div className="h-40 bg-card/3 rounded animate-pulse" />
            </div>
          </main>
        </div>
      </div>
