          ...
          <TabsContent value="projects" className="space-y-4 mt-4">
            ...
            {projectsError ? (
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-medium text-foreground mb-2">Error Loading Projects</h3>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <Badge className="bg-yellow-100 text-amber-400" aria-label="Status: Awaiting Approval">
                              Awaiting Approval
                            </Badge>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <Badge className="bg-blue-100 text-primary border-blue-300" aria-label={`Workflow step: ${project.assigned_step.nodeName}`}>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <Badge className="bg-green-100 text-emerald-400 border-green-300" aria-label="Status: Completed">
