          ...
          <div className="px-6 py-4">
            <div className="space-y-4">
              {newsletters.map((newsletter:any) => (
                <div key={newsletter.id} className="border rounded-lg p-4 hover:bg-card transition-colors">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-2 space-y-2 sm:space-y-0">
                        <div className="flex flex-col sm:flex-row sm:items-center space-y-1 sm:space-y-0 sm:space-x-2">
                          ...
                          {canViewNewsletters && newsletter.published_at && (
                            <Badge variant="outline" className="bg-green-100 text-emerald-400 border-green-200 text-xs w-fit">
                              Published
                            </Badge>
                          )}
                        </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center space-y-1 sm:space-y-0 sm:space-x-2 mb-3 text-xs text-muted-foreground">
