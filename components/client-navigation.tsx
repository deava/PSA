                  ...
                  navigationItems.filter((item: any) => item.allowUnassigned === true).map((item: NavigationItem) => {
                    ...
                    return (
                      <Link
                        key={item.name}
                        href={item.href}
                        className="flex items-center space-x-1 px-2 py-2 rounded-md text-sm font-medium text-muted-foreground"
                      >
                        <Icon className="w-4 h-4" />
                ...
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t">
                              ...
                              <div className="ml-4 space-y-1">
                                {userDepartments.map((dept:any) => (
                                  <Link
                                    ...
                                    className="flex items-center space-x-2 px-3 py-2 rounded-md text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-card"
                                    onClick={() => setIsMobileMenuOpen(false)}
                                  >
                  ...
                  {permissionsChecked && visibleItems.length > 6 && (
                    <div className="pt-2 border-t">
                      <p className="px-3 py-2 text-xs font-semibold text-muted-foreground uppercase tracking-wider">More</p>
