          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="view_projects" checked={formData.permissions.view_projects} onChange={(e) => handleInputChange('permissions.view_projects', e.target.checked)} className="rounded border-white/15" />
                <Label htmlFor="view_projects" className="text-sm font-normal">View Projects</Label>
              </div>
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="manage_projects" checked={formData.permissions.manage_projects} onChange={(e) => handleInputChange('permissions.manage_projects', e.target.checked)} className="rounded border-white/15" />
                <Label htmlFor="manage_projects" className="text-sm font-normal">Manage Projects (create, edit, delete)</Label>
              </div>
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="view_departments" checked={formData.permissions.view_departments} onChange={(e) => handleInputChange('permissions.view_departments', e.target.checked)} className="rounded border-white/15" />
                <Label htmlFor="view_departments" className="text-sm font-normal">View Departments</Label>
              </div>
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="execute_workflows" checked={formData.permissions.execute_workflows} onChange={(e) => handleInputChange('permissions.execute_workflows', e.target.checked)} className="rounded border-white/15" />
                <Label htmlFor="execute_workflows" className="text-sm font-normal">Execute Workflows</Label>
              </div>
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="manage_time" checked={formData.permissions.manage_time} onChange={(e) => handleInputChange('permissions.manage_time', e.target.checked)} className="rounded border-white/15" />
                <Label htmlFor="manage_time" className="text-sm font-normal">Manage Time (log and edit entries)</Label>
              </div>
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="view_team_capacity" checked={formData.permissions.view_team_capacity} onChange={(e) => handleInputChange('permissions.view_team_capacity', e.target.checked)} className="rounded border-white/15" />
                <Label htmlFor="view_team_capacity" className="text-sm font-normal">View Team Capacity</Label>
              </div>
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="edit_own_availability" checked={formData.permissions.edit_own_availability} onChange={(e) => handleInputChange('permissions.edit_own_availability', e.target.checked)} className="rounded border-white/15" />
