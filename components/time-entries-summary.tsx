        ...
        <CardContent className="p-6">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-2xl font-bold text-foreground">{stats.hoursThisWeek.toFixed(1)}h</p>
        ...
        <CardContent className="p-6">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-2xl font-bold text-foreground">{stats.hoursThisMonth.toFixed(1)}h</p>
              <p className="text-xs text-muted-foreground mt-1">Hours logged</p>
            </div>
          </div>
        </CardContent>
        ...
        <CardContent className="p-6">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-2xl font-bold text-foreground">{stats.averageHoursPerDay.toFixed(1)}h</p>
