    ...
    <Card>
      ...
      <CardContent>
        <div className="space-y-4">
          <div className="p-4 bg-amber-500/10 border border-yellow-200 rounded-md">
            <h4 className="font-medium text-amber-400 mb-2">⚠️ Action Required</h4>
          ...
          <div className="p-4 bg-primary/10 border border-blue-200 rounded-md">
            <h4 className="font-medium text-primary mb-2">💡 What This Does</h4>
          ...
          <div className="p-4 bg-card border border-white/10 rounded-md">
            <h4 className="font-medium text-foreground mb-2">🔍 Need the SQL Script?</h4>
