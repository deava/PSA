...
export async function PATCH(
  ...
  try {
    ...
    const canViewAll = await hasPermission(userProfile, Permission.VIEW_ALL_TIME_ENTRIES, undefined, admin);
    const canManageTime = await hasPermission(userProfile, Permission.MANAGE_TIME, undefined, admin);
