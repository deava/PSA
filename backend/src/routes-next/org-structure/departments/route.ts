...
export async function GET(request: NextRequest) {
  try {
    ...
    const canViewAll = await hasPermission(userProfile, Permission.VIEW_ALL_DEPARTMENTS, undefined, admin);
    const canManageWorkflows = await hasPermission(userProfile, Permission.MANAGE_WORKFLOWS, undefined, admin);
