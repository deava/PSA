...
export async function GET(request: NextRequest) {
  try {
    ...
    const hasAnalytics = await checkPermissionHybrid(userProfile, Permission.VIEW_ALL_ANALYTICS, undefined, admin);
    const hasAccountAnalytics = await checkPermissionHybrid(userProfile, Permission.VIEW_ALL_ACCOUNT_ANALYTICS, undefined, admin);
