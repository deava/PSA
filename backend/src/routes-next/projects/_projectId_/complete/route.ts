...
export async function POST(
  ...
  try {
    ...
    const hasManageAllProjects = await hasPermission(userProfile, Permission.MANAGE_ALL_PROJECTS, undefined, admin)
    ...
    const hasManageProjects = await hasPermission(userProfile, Permission.MANAGE_PROJECTS, undefined, admin)
