 ...
 */
function validateNoSyncNodes(nodes) {
    const errors = [];
 ...
 */
function validateSinglePathway(nodes, edges) {
    const errors = [];
 ...
 */
function validateConditionalNodes(nodes, edges) {
    const warnings = [];
 ...
 */
function findOrphanedNodes(nodes, edges) {
 ...
 */
function validateApprovalNodes(nodes, edges) {
    const errors = [];
 ...
 */
function validateRoleAssignments(nodes, roles) {
    const errors = [];
