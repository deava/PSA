...
async function GET(request, { params }) {
    ...
    try {
      ...
      `)
        ...
        // Get project details
        const project = await (0, client_portal_service_1.getClientProjectById)(user.id, id);
        if (!project) {
        ...
        debug_logger_1.logger.error('Error in GET /api/client/portal/projects/[id]', {}, error);
