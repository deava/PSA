...
async function loadSeedData(supabase: SupabaseClient) {
  ...
  await supabase.from('newsletters').upsert([
    { id: 'eeeeeeee-ffff-0001-0002-000000000001', title: 'Welcome to Worklo!', content: 'We are excited to announce the launch of Worklo, our new project management platform.', created_by: '11111111-1111-1111-1111-000000000002', is_published: true, published_at: '2025-01-15T10:00:00Z' },
