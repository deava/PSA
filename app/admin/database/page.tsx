    ...
    <div className="space-y-6">
      <div className="space-y-4">
        <div>
          ...
          <p className="text-muted-foreground mt-2">Monitor your Supabase database health and performance</p>
        </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="flex items-center justify-between p-3 border rounded-lg">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground truncate">User account information</p>
                </div>
              ...
              <div className="flex items-center justify-between p-3 border rounded-lg">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground truncate">Department definitions</p>
                </div>
                <div className="text-right flex-shrink-0 ml-2">
                  <span className="text-lg font-semibold">1</span>
                  <p className="text-xs text-muted-foreground">rows</p>
              ...
              <div className="flex items-center justify-between p-3 border rounded-lg">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground truncate">Role definitions</p>
                </div>
                <div className="text-right flex-shrink-0 ml-2">
                  <span className="text-lg font-semibold">1</span>
                  <p className="text-xs text-muted-foreground">rows</p>
              ...
              <div className="flex items-center justify-between p-3 border rounded-lg">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground truncate">User role assignments</p>
                </div>
                <div className="text-right flex-shrink-0 ml-2">
                  <span className="text-lg font-semibold">1</span>
                  <p className="text-xs text-muted-foreground">rows</p>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-emerald-500/10 border border-green-200 rounded-lg">
