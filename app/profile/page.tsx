...
export default function ProfilePage() {
  ...
  return (
    <RoleGuard allowUnassigned={true}>
      ...
      {saveSuccess && (
        <div className="bg-emerald-500/10 border border-green-200 rounded-md p-4">
          <div className="flex">
            ...
            <CardContent className="space-y-4">
              <div className="flex flex-col items-center space-y-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">{(userProfile as any).email}</p>
                </div>
              </div>
                  ...
                  {(() => {
                    ...
                    return depts && depts.length > 0
                      ? depts.map((name: string, index: number) => (
                          <span
                            key={index}
                            className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-emerald-400"
                          >
                            {name}
                          </span>
                        ))
