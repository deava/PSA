    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-card">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Checking setup status...</p>
        </div>
      </div>
    );
  }
        ...
        <Card className="max-w-lg w-full">
          ...
          <CardContent className="space-y-4">
            <div className="bg-card p-4 rounded-lg">
              <h3 className="font-medium text-foreground mb-2">To complete setup:</h3>
              <ol className="list-decimal list-inside space-y-3 text-sm text-muted-foreground">
                <li>
                  Generate a secret key:
                  <code className="block bg-muted px-2 py-1 rounded mt-1 text-xs">openssl rand -hex 32</code>
                </li>
                <li>
                  Add it to your environment:
                  <ul className="list-disc list-inside ml-4 mt-1 space-y-1">
                    <li><strong>Local dev:</strong> Add <code className="bg-muted px-1 rounded">SETUP_SECRET=your-key</code> to <code className="bg-muted px-1 rounded">.env.local</code></li>
                    <li><strong>Vercel:</strong> Add <code className="bg-muted px-1 rounded">SETUP_SECRET</code> in Settings â†’ Environment Variables</li>
                  </ul>
                </li>
            ...
            <p className="text-xs text-muted-foreground">
              See <code className="bg-muted px-1 rounded">docs/setup/FIRST_TIME_SETUP.md</code> for the full guide.
            </p>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-card p-4">
        <Card className="max-w-lg w-full">
          ...
          <CardContent className="space-y-4">
            <div className="bg-card p-4 rounded-lg">
              <h3 className="font-medium text-foreground mb-2">Setup Steps:</h3>
              <ol className="list-decimal list-inside space-y-2 text-sm text-muted-foreground">
                <li>Push database schema: <code className="bg-muted px-1 rounded text-xs">supabase db push</code> (if not done)</li>
...
function SetupPageLoading() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-card">
      <div className="text-center">
        <Loader2 className="h-8 w-8 animate-spin text-blue-600 mx-auto" />
        <p className="mt-2 text-sm text-muted-foreground">Loading setup...</p>
      </div>
    </div>
  );
}
