...
export default function ClientInvitePage() {
  ...
  const loadInvitation = useCallback(async () => {
    try {
      const res = await apiFetch(`/api/client/accept-invite/${token}`);
      ...
      <div className="w-full max-w-lg">
        ...
        {pageState === 'form' && invitation && (
          <Card>
            ...
            <CardContent className="space-y-6">
              {/* Invitation Details */}
              <div className="rounded-lg bg-primary/10 border border-blue-200 p-4 space-y-3">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="client-position">Company Position <span className="text-muted-foreground font-normal">(optional)</span></Label>
                  <Input
                    id="client-position"
                    type="text"
        ...
        {pageState === 'success' && (
          <Card>
            ...
            <CardContent>
              {invitation && (
                <div className="rounded-lg bg-emerald-500/10 border border-green-200 p-4 text-sm text-emerald-400 space-y-1">
